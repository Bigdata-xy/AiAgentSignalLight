...
Some Chinese text in the long planning and analysis documents is currently encoded incorrectly and appears as mojibake. Treat those files as historical/reference material until the text is restored or rewritten in UTF-8.
